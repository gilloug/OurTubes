...
def main(mysql=None, connected_as=''):
    ...
    <title>OurTubes - Join Channel</title>
    </head>
    <body>
	  ...
	  <li class="no-padding">
		...
		<div class="collapsible-body">
		  <ul>
                    ...
                    <li class="green active"><a href="joinChan">join</a></li>
	...
	<ul class="right hide-on-med-and-down">
	  <li class="active">
	    ...
	    <ul  id='dropdown1' class='dropdown-content'>
              ...
              <li class="active"><a href="joinChan" class="black-text">join</a></li>
<li><a id="lve" name="lve" href="#!" class="black-text">leave</a></li>
	...
	<label for="inputPrivatePassword" class="sr-only">Password</label>
	<input type="password" name="inputPassword" id="inputPassword" class="form-control" placeholder="Password" required>
	<input type="checkbox" name="isAdmin" id="isAdmin" class="form-control" required>
	<label for="isAdmin" class="sr-only">I am the administrator</label>
	<br/><br/>
	<button id="btnJoin" class="btn btn-lg btn-primary btn-block" type="button">Join</button>
	<script>
	  $(function() {
	  ...
	  error: function(error) {
	  Materialize.toast('Cannot join chan', 4000, 'red')
	  }
	  });
	  });
	  });
    ...
    conn.close()
    i = 0
    ret += """<ul class="container collection">"""
    if data and len(data) is not 0:
        for chan in data:
            if i == 0:
                ret += """<li class="divider"></li><li class="collection-item">
